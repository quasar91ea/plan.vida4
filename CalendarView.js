                ...
                <div className="grid grid-cols-7 gap-px bg-brand-border border-t border-l border-brand-border rounded-lg overflow-hidden mt-6">
                    ...
                    {calendarDays.map((dayInfo, index) => {
                        ...
                        return (
                            ...
                            >
                                 <span className={`text-xs sm:text-sm font-semibold ${!dayInfo.isCurrentMonth ? 'text-brand-tertiary opacity-50' : 'h-6 w-6 flex items-center justify-center'} ${isToday ? 'bg-brand-accent text-white rounded-full flex items-center justify-center h-6 w-6' : 'h-6 w-6 flex items-center justify-center'}`}>
                                    {dayInfo.day}
                                </span>
